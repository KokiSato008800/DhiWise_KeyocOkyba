...
class ListlinetwentyfiveItemWidget extends StatelessWidget {
  ListlinetwentyfiveItemWidget(this.listlinetwentyfiveItemModelObj,
      {this.onTapColumnlinetwentyfive});

  ListlinetwentyfiveItemModel listlinetwentyfiveItemModelObj;

  var controller = Get.find<IstriggerFilterController>();
