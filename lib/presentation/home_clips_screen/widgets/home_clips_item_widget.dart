...
class HomeClipsItemWidget extends StatelessWidget {
  HomeClipsItemWidget(this.homeClipsItemModelObj,
      {this.onTapColumnlinetwentyfive});

  HomeClipsItemModel homeClipsItemModelObj;

  var controller = Get.find<HomeClipsController>();
