...
class MapSelectedtagScreen extends GetWidget<MapSelectedtagController> {
  @override
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          CustomIconButton(
                                                                              ...
                                                                              child: CustomImageView(imagePath: ImageConstant.imgGroup106))
                                                                        ]))
                                                              ])),
                                                      Container(
                                                          width: size.width,
                                                          ...
                                                          child: Row(
                                                              ...
                                                              children: [
                                                                        ...
                                                                        children: [
                                                                          SingleChildScrollView(
                                                                              ...
                                                                              child: IntrinsicWidth(
                                                                                ...
                                                                                Padding(
                                                                                    padding: getPadding(top: 1, bottom: 16),
                                                                ...
                                                                GestureDetector(
                                                                    onTap: () {
                                                                      onTapColumnonehundredthirtyfive();
                                                                    },
                                                                    child: Container(
                                                                        padding: getPadding(top: 20, bottom: 20),
                                                                        child: Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.end, children: [
                                                                          Padding(
                                                                              padding: getPadding(top: 88, right: 3),
                                                                              child: Text("lbl10".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterBold16)),
                                                                          Container(
                                                                              width: getHorizontalSize(99.00),
                                                                              margin: getMargin(top: 1),
                                                                              child: Text("msg_jason_s_recomme4".tr, maxLines: null, textAlign: TextAlign.left, style: AppStyle.txtInterRegular12Gray600))
                                                                        ])))
                                                              ]))
                                                    ])))
                                      ]))
