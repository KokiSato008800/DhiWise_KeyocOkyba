...
class DetailModalDatepickerOneScreen
    extends GetWidget<DetailModalDatepickerOneController> {
  @override
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: Stack(alignment: Alignment.centerLeft, children: [
                                                                              Align(alignment: Alignment.center, child: Container(height: getVerticalSize(50.00), width: getHorizontalSize(288.00), decoration: BoxDecoration(color: ColorConstant.whiteA700))),
                                                                              CustomImageView(imagePath: ImageConstant.img20221130, height: getVerticalSize(50.00), width: getHorizontalSize(200.00), alignment: Alignment.centerLeft, margin: getMargin(left: 37))
                                                                            ])))
                                                                  ]))),
                                                      Align(
                                                          alignment: Alignment
  ...
  onTapImgIMG47875() {
    Get.toNamed(AppRoutes.detailModalDatepickerScreen);
  }
}
