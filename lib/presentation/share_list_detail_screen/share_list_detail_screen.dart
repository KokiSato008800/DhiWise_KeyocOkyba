...
class ShareListDetailScreen extends GetWidget<ShareListDetailController> {
  @override
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child: Text(
                                                                          ...
                                                                          textAlign: TextAlign
                                                                              .left,
                                                                          style:
                                                                              AppStyle.txtInterRegular12Indigo400))
                                                                ]))
                                                      ]),
                                                  Padding(
                                                      padding:
                                                                    ...
                                                                    child: Stack(alignment: Alignment.topRight, children: [
                                                                      ...
                                                                      Align(
                                                                          ...
                                                                          child: Padding(
                                                                              ...
                                                                              child: Text("msg_10_minutes_before".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtInterRegular12Gray600)))
                                                                    ]))))
                                                      ]))
                                                ])),
                                        Container(
                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              decoration: AppDecoration.fillGray50.copyWith(borderRadius: BorderRadiusStyle.circleBorder12),
                                                                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Container(width: getHorizontalSize(208.00), child: Text("msg_i_celebrated_my".tr, maxLines: null, textAlign: TextAlign.left, style: AppStyle.txtInterRegular12Gray600))
                                                                              ]))),
                                                                      Align(
                                                                          alignment: Alignment
                                                                              .topRight,
                                                                    ...
                                                                    child: Stack(
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                              ...
                                                                              child: Text("lbl_2022_12_24".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterRegular12Bluegray100)),
                                                                          CustomImageView(
                                                                              imagePath: ImageConstant.img116x16,
                                                                              height: getSize(12.00),
                                                                              width: getSize(12.00),
                                                                              alignment: Alignment.bottomRight,
                                                                              margin: getMargin(right: 9, bottom: 1))
                                                                        ])),
                                                                CustomTextFormField(
                                                                    width: 330,
                                                                    focusNode:
