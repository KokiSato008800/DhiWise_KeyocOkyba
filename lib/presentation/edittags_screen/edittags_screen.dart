...
class EdittagsScreen extends GetWidget<EdittagsController> {
  @override
            ...
            appBar: CustomAppBar(
                ...
                actions: [
                  Container(
                      ...
                      margin: getMargin(left: 202, top: 14, bottom: 14),
                  ...
                  AppbarImage(
                      ...
                      margin:
                          getMargin(left: 12, top: 14, right: 20, bottom: 14),
                      onTap: onTapFiftyOne)
                ]),
            body: Container(
                width: size.width,
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          margin: getMargin(left: 22, top: 7, right: 22),
                              ...
                              children: [
                                Container(
                                    ...
                                    child: Row(children: [
                                      ...
                                      Container(
                                          width: getHorizontalSize(54.00),
                                          margin: getMargin(top: 1, right: 126),
                                          padding: getPadding(
                                              left: 16,
                                              top: 12,
                                              right: 16,
