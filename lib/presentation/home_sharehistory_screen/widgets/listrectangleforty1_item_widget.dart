...
class Listrectangleforty1ItemWidget extends StatelessWidget {
  Listrectangleforty1ItemWidget(this.listrectangleforty1ItemModelObj);

  Listrectangleforty1ItemModel listrectangleforty1ItemModelObj;

  var controller = Get.find<HomeSharehistoryController>();
