...
class Listlinetwentyfive1ItemWidget extends StatelessWidget {
  Listlinetwentyfive1ItemWidget(this.listlinetwentyfive1ItemModelObj,
      {this.onTapColumnlinetwentyfive});

  Listlinetwentyfive1ItemModel listlinetwentyfive1ItemModelObj;

  var controller = Get.find<ImportlistOpenurlImportlistController>();
