...
class Listrectangletwentynine1ItemWidget extends StatelessWidget {
  Listrectangletwentynine1ItemWidget(this.listrectangletwentynine1ItemModelObj);

  Listrectangletwentynine1ItemModel listrectangletwentynine1ItemModelObj;

  var controller = Get.find<ImportlistSuccessmodalController>();
