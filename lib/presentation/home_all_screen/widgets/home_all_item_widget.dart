...
class HomeAllItemWidget extends StatelessWidget {
  HomeAllItemWidget(this.homeAllItemModelObj, {this.onTapColumnlinetwentyfive});

  HomeAllItemModel homeAllItemModelObj;

  var controller = Get.find<HomeAllController>();
